...
import { AddonLandingProvider } from '@addon/landing/providers/landing';

/**
 * Page that displays the list of calendar events.
 */
@IonicPage({ segment: 'addon-schoolofsales-my-schoolofsales' })
@Component({
    selector: 'page-addon-schoolofsales-my-schoolofsales',
    templateUrl: 'my-schoolofsales.html',
})
export class AddonSchoolOfSalesMySchoolOfSalesPage implements OnDestroy {
    ...
    constructor(private domUtils: CoreDomUtilsProvider,
            private landingProvider: AddonLandingProvider,
    ...
    protected fetchUserCourses(): Promise<any> {
        return this.landingProvider.getUserCourses(null, null, AddonLandingProvider.TYPE_SCHOOL_OF_SALES).then((courses) => {
            const promises = [],
                courseIds = courses.map((course) => {
                return course.id;
            });
