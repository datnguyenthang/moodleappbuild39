...
var capture_media_CoreEmulatorCaptureMediaPage = /** @class */ (function () {
    ...
    CoreEmulatorCaptureMediaPage.prototype.done = function () {
        ...
        var fileName = this.type + '_' + this.timeUtils.readableTimestamp() + '.' + this.extension, path = this.textUtils.concatenatePaths(file["b" /* CoreFileProvider */].TMPFOLDER, 'media/' + fileName), loadingModal = this.domUtils.showModalLoading();
        this.fileProvider.writeFile(path, this.mediaBlob).then(function (fileEntry) {
            if (_this.isImage && !_this.isCaptureImage) {
                ...
                return _this.fileProvider.getMetadata(fileEntry).then(function (metadata) {
                    var mediaFile = {
                        name: fileEntry.name,
                    ...
                    _this.dismissWithData([mediaFile]);
                });
            }
        }).catch(function (err) {
    ...
    CoreEmulatorCaptureMediaPage = __decorate([
        ...
        __metadata("design:paramtypes", [ionic_angular["H" /* ViewController */], ionic_angular["u" /* NavParams */], dom["b" /* CoreDomUtilsProvider */],
            time["b" /* CoreTimeUtilsProvider */], file["b" /* CoreFileProvider */],
            utils_text["b" /* CoreTextUtilsProvider */], core["j" /* ChangeDetectorRef */]])
    ...
    CoreEmulatorCaptureMediaPageModule = capture_media_module___decorate([
        Object(core["I" /* NgModule */])({
            ...
            imports: [
                ...
                ionic_angular["m" /* IonicPageModule */].forChild(capture_media_CoreEmulatorCaptureMediaPage),
...
var seconds_to_hms = __webpack_require__(1613);

// EXTERNAL MODULE: ./src/providers/logger.ts
var logger = __webpack_require__(6);

// EXTERNAL MODULE: ./src/components/chrono/chrono.ts
var chrono = __webpack_require__(1624);
...
function View_CoreChronoComponent_0(_l) { return core["_57" /* ɵvid */](0, [core["_47" /* ɵpid */](0, seconds_to_hms["a" /* CoreSecondsToHMSPipe */], [logger["b" /* CoreLoggerProvider */], utils_text["b" /* CoreTextUtilsProvider */]]), (_l()(), core["_31" /* ɵeld */](1, 0, null, null, 2, "span", [["role", "timer"]], null, null, null, null, null)), (_l()(), core["_55" /* ɵted */](2, null, ["", ""])), core["_49" /* ɵppd */](3, 1)], null, function (_ck, _v) { var _co = _v.component; var currVal_0 = core["_56" /* ɵunv */](_v, 2, 0, _ck(_v, 3, 0, core["_44" /* ɵnov */](_v, 0), (_co.time / 1000))); _ck(_v, 2, 0, currVal_0); }); }
