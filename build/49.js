...
var general_CoreSettingsGeneralPage = /** @class */ (function () {
    function CoreSettingsGeneralPage(configProvider, fileProvider, eventsProvider, langProvider, domUtils, pushNotificationsProvider, localNotificationsProvider, settingsHelper) {
        var _this = this;
    ...
    CoreSettingsGeneralPage.prototype.languageChanged = function () {
        ...
        this.langProvider.changeCurrentLanguage(this.selectedLanguage).finally(function () {
            _this.eventsProvider.trigger(events["b" /* CoreEventsProvider */].LANGUAGE_CHANGED, _this.selectedLanguage);
        });
    };
    /**
    ...
    __decorate([
        Object(core["_9" /* ViewChild */])(ionic_angular["B" /* Segment */]),
        __metadata("design:type", ionic_angular["B" /* Segment */])
    ...
    CoreSettingsGeneralPageModule = general_module___decorate([
        Object(core["I" /* NgModule */])({
            ...
            imports: [
                ...
                ionic_angular["m" /* IonicPageModule */].forChild(general_CoreSettingsGeneralPage),
...
var segment_button = __webpack_require__(509);
...
var segment = __webpack_require__(799);
