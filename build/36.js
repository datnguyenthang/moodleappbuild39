...
var user_delegate = __webpack_require__(108);
...
var profile_CoreUserProfilePage = /** @class */ (function () {
    function CoreUserProfilePage(navParams, userProvider, userHelper, domUtils, translate, eventsProvider, coursesProvider, sitesProvider, mimetypeUtils, fileUploaderHelper, userDelegate, navCtrl, svComponent) {
        ...
        this.obsProfileRefreshed = eventsProvider.on(providers_user["b" /* CoreUserProvider */].PROFILE_REFRESHED, function (data) {
            ...
            if (_this.userId == _this.site.getUserId() && user.profileimageurl != _this.site.getInfo().userpictureurl) {
                ...
                return _this.sitesProvider.updateSiteInfo(_this.site.getId()).then(function () {
                    if (user.profileimageurl != _this.site.getInfo().userpictureurl) {
                        ...
                        _this.eventsProvider.trigger(providers_user["b" /* CoreUserProvider */].PROFILE_PICTURE_UPDATED, {
                            userId: _this.userId,
    ...
    CoreUserProfilePage.prototype.refreshUser = function (refresher) {
        ...
        Promise.all(promises).finally(function () {
            _this.fetchUser().finally(function () {
                _this.eventsProvider.trigger(providers_user["b" /* CoreUserProvider */].PROFILE_REFRESHED, {
    ...
    CoreUserProfilePage = __decorate([
        ...
        __metadata("design:paramtypes", [ionic_angular["u" /* NavParams */], providers_user["b" /* CoreUserProvider */], helper["a" /* CoreUserHelperProvider */],
            dom["b" /* CoreDomUtilsProvider */], _ngx_translate_core["c" /* TranslateService */], events["b" /* CoreEventsProvider */],
            courses["b" /* CoreCoursesProvider */], sites["b" /* CoreSitesProvider */],
            mimetype["b" /* CoreMimetypeUtilsProvider */], providers_helper["a" /* CoreFileUploaderHelperProvider */],
            user_delegate["a" /* CoreUserDelegate */], ionic_angular["t" /* NavController */],
    ...
    CoreUserProfilePageModule = profile_module___decorate([
        Object(core["I" /* NgModule */])({
            ...
            imports: [
                ...
                ionic_angular["m" /* IonicPageModule */].forChild(profile_CoreUserProfilePage),
...
function View_CoreUserProfilePage_Host_0(_l) { return core["_57" /* ɵvid */](0, [(_l()(), core["_31" /* ɵeld */](0, 0, null, null, 1, "page-core-user-profile", [], null, null, null, View_CoreUserProfilePage_0, RenderType_CoreUserProfilePage)), core["_30" /* ɵdid */](1, 180224, null, 0, profile_CoreUserProfilePage, [nav_params["a" /* NavParams */], providers_user["b" /* CoreUserProvider */], helper["a" /* CoreUserHelperProvider */], dom["b" /* CoreDomUtilsProvider */], translate_service["a" /* TranslateService */], events["b" /* CoreEventsProvider */], courses["b" /* CoreCoursesProvider */], sites["b" /* CoreSitesProvider */], mimetype["b" /* CoreMimetypeUtilsProvider */], providers_helper["a" /* CoreFileUploaderHelperProvider */], user_delegate["a" /* CoreUserDelegate */], nav_controller["a" /* NavController */], [2, split_view["a" /* CoreSplitViewComponent */]]], null, null)], null, null); }
