...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__player__ = __webpack_require__(2322);
    ...
    AddonModScormPlayerPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__player__["a" /* AddonModScormPlayerPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_ion_tabs_ion_tabs__ = __webpack_require__(436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_scorm__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_helper__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_scorm_sync__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__classes_data_model_12__ = __webpack_require__(2323);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModScormPlayerPage = /** @class */ (function () {
    function AddonModScormPlayerPage(navParams, modalCtrl, eventsProvider, sitesProvider, syncProvider, timeUtils, scormProvider, scormHelper, scormSyncProvider, tabs) {
        ...
        this.mode = navParams.get('mode') || __WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].MODENORMAL;
        ...
        this.syncProvider.blockOperation(__WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].COMPONENT, this.scorm.id, 'player');
    }
    /**
    ...
    AddonModScormPlayerPage.prototype.ngOnInit = function () {
        ...
        this.fetchData().then(function () {
            if (_this.currentSco) {
                ...
                return promise.catch(function (error) {
                    __WEBPACK_IMPORTED_MODULE_5__providers_utils_dom__["a" /* CoreDomUtils */].instance.showErrorModalDefault(error, 'addon.mod_scorm.errorgetscorm', true);
                }).finally(function () {
                    // Load SCO.
        ...
        this.tocObserver = this.eventsProvider.on(__WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].UPDATE_TOC_EVENT, function (data) {
        ...
        this.launchNextObserver = this.eventsProvider.on(__WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].LAUNCH_NEXT_SCO_EVENT, function (data) {
            if (data.scormId === _this.scorm.id && _this.nextSco) {
                _this.loadSco(_this.nextSco);
            }
        }, this.siteId);
        this.launchPrevObserver = this.eventsProvider.on(__WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].LAUNCH_PREV_SCO_EVENT, function (data) {
            if (data.scormId === _this.scorm.id && _this.previousSco) {
                _this.loadSco(_this.previousSco);
            }
        }, this.siteId);
        this.goOfflineObserver = this.eventsProvider.on(__WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */].GO_OFFLINE_EVENT, function (data) {
            if (data.scormId === _this.scorm.id && !_this.offline) {
                ...
                setTimeout(function () {
                    _this.scormHelper.convertAttemptToOffline(_this.scorm, _this.attempt).catch(function (error) {
                        __WEBPACK_IMPORTED_MODULE_5__providers_utils_dom__["a" /* CoreDomUtils */].instance.showErrorModalDefault(error, 'core.error', true);
                    }).then(function () {
                        _this.refreshToc();
                    });
                }, 200);
    ...
    AddonModScormPlayerPage.prototype.loadSco = function (sco) {
        ...
        if (!this.dataModel) {
            // Create the model.
            this.dataModel = new __WEBPACK_IMPORTED_MODULE_11__classes_data_model_12__["a" /* AddonModScormDataModel12 */](this.eventsProvider, this.scormProvider, this.siteId, this.scorm, sco.id, this.attempt, this.userData, this.mode, this.offline);
    ...
    AddonModScormPlayerPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sync__["a" /* CoreSyncProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_utils_time__["b" /* CoreTimeUtilsProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_scorm__["a" /* AddonModScormProvider */],
            __WEBPACK_IMPORTED_MODULE_9__providers_helper__["a" /* AddonModScormHelperProvider */],
            __WEBPACK_IMPORTED_MODULE_10__providers_scorm_sync__["a" /* AddonModScormSyncProvider */],
            __WEBPACK_IMPORTED_MODULE_7__components_ion_tabs_ion_tabs__["a" /* CoreIonTabsComponent */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_scorm__ = __webpack_require__(179);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
