...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__contacts__ = __webpack_require__(2189);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_components_module__ = __webpack_require__(2164);
...
var AddonMessagesContactsPageModule = /** @class */ (function () {
    function AddonMessagesContactsPageModule() {
    }
    AddonMessagesContactsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__contacts__["a" /* AddonMessagesContactsPage */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__contacts__["a" /* AddonMessagesContactsPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__directives_directives_module__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pipes_pipes_module__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_search_components_components_module__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_discussions_discussions__ = __webpack_require__(2165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_confirmed_contacts_confirmed_contacts__ = __webpack_require__(2166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_contact_requests_contact_requests__ = __webpack_require__(2167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_contacts_contacts__ = __webpack_require__(2168);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_pushnotifications_providers_delegate__ = __webpack_require__(91);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_messages__ = __webpack_require__(99);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddonMessagesContactsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_events__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_sites__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_tabs_tabs__ = __webpack_require__(177);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
 ...
 */
var AddonMessagesContactsPage = /** @class */ (function () {
    function AddonMessagesContactsPage(eventsProvider, sitesProvider, navCtrl, messagesProvider) {
        ...
        this.contactRequestsCountObserver = eventsProvider.on(__WEBPACK_IMPORTED_MODULE_4__providers_messages__["a" /* AddonMessagesProvider */].CONTACT_REQUESTS_COUNT_EVENT, function (data) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_5__components_split_view_split_view__["a" /* CoreSplitViewComponent */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__components_split_view_split_view__["a" /* CoreSplitViewComponent */])
    ], AddonMessagesContactsPage.prototype, "splitviewCtrl", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_6__components_tabs_tabs__["a" /* CoreTabsComponent */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_6__components_tabs_tabs__["a" /* CoreTabsComponent */])
    ], AddonMessagesContactsPage.prototype, "tabsComponent", void 0);
    AddonMessagesContactsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-messages-contacts',template:/*ion-inline-start:"D:\Project\ATS\moodleapp\src\addon\messages\pages\contacts\contacts.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ \'addon.messages.contacts\' | translate }}</ion-title>\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="gotoSearch()" [attr.aria-label]="\'addon.messages.search\' | translate">\n\n                <ion-icon name="search"></ion-icon>\n\n            </button>\n\n            <!-- Add an empty context menu so discussion page can add items in split view, otherwise the menu disappears in some cases. -->\n\n            <core-context-menu></core-context-menu>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<core-split-view>\n\n    <ion-content>\n\n        <core-tabs>\n\n            <core-tab [title]="\'addon.messages.contacts\' | translate" (ionSelect)="selectUser(\'contacts\')">\n\n                <ng-template>\n\n                    <addon-messages-confirmed-contacts (onUserSelected)="selectUser(\'contacts\', $event.userId, $event.onInit)"></addon-messages-confirmed-contacts>\n\n                </ng-template>\n\n            </core-tab>\n\n            <core-tab [title]="\'addon.messages.requests\' | translate" [badge]="contactRequestsCount" (ionSelect)="selectUser(\'requests\')">\n\n                 <ng-template>\n\n                    <addon-messages-contact-requests (onUserSelected)="selectUser(\'requests\', $event.userId, $event.onInit)"></addon-messages-contact-requests>\n\n                </ng-template>\n\n            </core-tab>\n\n        </core-tabs>\n\n    </ion-content>\n\n</core-split-view>'/*ion-inline-end:"D:\Project\ATS\moodleapp\src\addon\messages\pages\contacts\contacts.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_events__["b" /* CoreEventsProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_sites__["b" /* CoreSitesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__providers_messages__["a" /* AddonMessagesProvider */]])
