...
var data_components_components_module = __webpack_require__(490);
...
var edit_AddonModDataEditPage = /** @class */ (function () {
        ...
        return this.dataHelper.hasEditDataChanged(inputData, this.fieldsArray, this.data.id, this.entry.contents).then(function (changed) {
            ...
            return _this.dataHelper.getEditDataFromForm(inputData, _this.fieldsArray, _this.data.id, entryTemp, _this.entry.contents, _this.offline).catch(function (e) {
                ...
                if ((_this.entryId && result.updated) || (!_this.entryId && result.newentryid)) {
                    ...
                    if (result.sent) {
                        _this.eventsProvider.trigger(events["b" /* CoreEventsProvider */].ACTIVITY_DATA_SENT, { module: 'data' });
                    }
                    var promises = [];
    ...
    AddonModDataEditPage = __decorate([
        ...
        __metadata("design:paramtypes", [ionic_angular["u" /* NavParams */], utils_utils["b" /* CoreUtilsProvider */], groups["a" /* CoreGroupsProvider */],
            dom["b" /* CoreDomUtilsProvider */], fields_delegate["a" /* AddonModDataFieldsDelegate */],
            course["b" /* CoreCourseProvider */], data["a" /* AddonModDataProvider */],
            offline["a" /* AddonModDataOfflineProvider */], helper["a" /* AddonModDataHelperProvider */],
            sites["b" /* CoreSitesProvider */], ionic_angular["t" /* NavController */], _ngx_translate_core["c" /* TranslateService */],
            events["b" /* CoreEventsProvider */], fileuploader["a" /* CoreFileUploaderProvider */],
    ...
    AddonModDataEditPageModule = edit_module___decorate([
        Object(core["I" /* NgModule */])({
            ...
            imports: [
                ...
                ionic_angular["m" /* IonicPageModule */].forChild(edit_AddonModDataEditPage),
...
var style_ngfactory = __webpack_require__(1634);
